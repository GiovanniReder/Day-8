...
while (b < starWarsCharacters.length) {
...
/* ESERCIZIO 7
  ...
  Una volta fatto, modifica la massa di qualche elemento dell'equipaggio e vedi se riesci ad ottenere un messaggio 
  diverso.
*/
let crewMass2 = 957;
...
} else if (crewMass2 > 500 && crewMass < 700) {
  console.log("Ship is half loaded");
} else if (crewMass2 > 700 && crewMass < 900) {
  console.log("Warning: Load is over 700");
} else if (crewMass2 > 900 && crewMass < 1000) {
...
/* --EXTRA-- ESERCIZIO 9
  Utilizzando gli elementi presenti nell'array "femaleCharacters" rimuovi dall'array "charactersNames" le 
